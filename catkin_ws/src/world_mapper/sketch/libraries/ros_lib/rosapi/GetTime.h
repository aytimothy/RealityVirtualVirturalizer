#ifndef _ROS_SERVICE_GetTime_h
#define _ROS_SERVICE_GetTime_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETTIME[] = "rosapi/GetTime";

  class GetTimeRequest : public ros::Msg
  {
    public:
  ...
  class GetTimeResponse : public ros::Msg
  {
    public:
