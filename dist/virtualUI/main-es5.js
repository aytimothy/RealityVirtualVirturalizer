...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var ScannerService = /*#__PURE__*/function () {
      ...
      _createClass(ScannerService, [{
        ...
        value: function requestScannerStatus() {
          ...
          var request = new roslib__WEBPACK_IMPORTED_MODULE_2__["ServiceRequest"]({
            request: "status"
          });
          this.scanService.callService(request, function (res) {
        ...
        value: function toggleScanner(status) {
          ...
          if (status) {
            ...
            this.scanService.callService(request, function (res) {
              ...
              _this9.requestScannerStatus(); // update the scanner status
    ...
    var SidenavComponent = /*#__PURE__*/function () {
      ...
      _createClass(SidenavComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.__BridgeService.getConnnectionStatus().subscribe(function (status) {
            _this10.isConnected = status; // update status in local component when changes

            if (_this10.isConnected) {
              _this10.__ScannerService.requestScannerStatus();
            }
          }); // subscribe to scanner status


          this.__ScannerService.getScannerStatus().subscribe(function (status) {
            _this10.isScanning = status;
          });
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.__BridgeService.estabishConnection(function (response) {
            if (response.type == "open") {
              _this11.bridge_status_msg = "Connected";
              _this11.bridge_status_icon = 'phonelink';
              _this11.loading = false;
            }

            if (response.type == 'close') {
              _this11.bridge_status_msg = 'Connection Closed';
              _this11.bridge_status_icon = 'close';
              _this11.loading = false;
            }

            if (response.type == 'error') {
              _this11.bridge_status_msg = "Connection Failed";
              _this11.bridge_status_icon = 'error';
              _this11.loading = false;
            }
          }); // subscribe to scanner status
          ...
          this.__ScannerService.getScannerStatus().subscribe(function (isScanning) {
            if (isScanning) {
              _this11.scan_status_msg = 'Enabled';
              _this11.scan_status_icon = 'cast';
            }

            if (!isScanning) {
              _this11.scan_status_msg = 'Disabled';
              _this11.scan_status_icon = 'close';
            }
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/aytimothy/GitHub/RealityVirtualVirturalizer/web/-RealityVirtualVirturalizer-Interface/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
